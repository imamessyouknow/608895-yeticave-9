...
else {http_responce_code(404);}

$lot_by_id = 'select l.name as lot_name, start_price, date_create, date_end, img, current_price, description, c.name as cat_name
...
$lot_content = include_template('lot_template.php',['lot_info' => $lotbyid_array, 'date_diff' => $diff_format,'timer_class' => $time_left_class,'categories' => $categories]);
print($lot_content);
?>