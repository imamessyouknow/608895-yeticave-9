      ...
      <div class="lot-item__content">
        <div class="lot-item__left">
          <div class="lot-item__image">
            <img src="<?=$lot_info['img']; ?>" width="730" height="548" alt="Сноуборд">
          </div>
          <p class="lot-item__category">Категория: <?=htmlspecialchars($lot_info['cat_name']); ?></p>
          ...
          <div class="lot-item__state">
            ...
            <div class="lot-item__cost-state">
              <div class="lot-item__rate">
                ...
                <span class="lot-item__cost"><?=htmlspecialchars(format_sum($lot_info['start_price'])); ?></span>
              </div>
			  <!--
